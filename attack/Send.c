...
int message_sign(unsigned char beacon[], unsigned char base64message[], int flag, unsigned char* prikey_addr, unsigned char* pubkey_addr)
{
        ...
        while(1)
        {
                ...
                if(hash_beacon_encode[63]=='0'&&hash_beacon_encode[62]=='0'&&(hash_beacon_encode[61]=='0'/*&&(hash_beacon_encode[60]=='0'||hash_beacon_encode[60]=='c'||hash_beacon_encode[60]=='4'||hash_beacon_encode[60]=='8'||hash_beacon_encode[60]=='2'||hash_beacon_encode[60]=='e'||hash_beacon_encode[60]=='6'||hash_beacon_encode[60]=='a'))*/||hash_beacon_encode[61]=='8'||hash_beacon_encode[61]=='4'||hash_beacon_encode[61]=='c'))//&&(hash_beacon_encode[60]=='0'||hash_beacon_encode[60]=='c'||hash_beacon_encode[60]=='4'||hash_beacon_encode[60]=='8'||hash_beacon_encode[60]=='2'||hash_beacon_encode[60]=='e'||hash_beacon_encode[60]=='6'||hash_beacon_encode[60]=='a'))//&&(digest_encode[61]=='0'))
                {
                        break;
                }
